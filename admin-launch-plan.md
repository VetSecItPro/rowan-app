...
3. **Admin Dashboard:** Full oversight at `admin-dashboard`
...
### **Access & Security**
- **URL:** `admin-dashboard` (stealth naming)
...
• Access full dashboard: https://admin-dashboard
...
- Set up `admin-dashboard` subdomain routing
