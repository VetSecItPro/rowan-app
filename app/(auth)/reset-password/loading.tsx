  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-emerald-950 dark:via-teal-950 dark:to-cyan-950">
      <div className="w-full max-w-md p-6">
        {/* Card */}
        <div className="bg-white/80 dark:bg-gray-800/80 p-8 rounded-xl border border-gray-200 dark:border-gray-700">
          {/* Icon */}
          ...
          <div className="mb-6">
            <div className="h-4 w-36 bg-gray-200 dark:bg-gray-700 rounded mb-2 animate-pulse" />
            <div className="h-12 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
          </div>
