...
export default function Error({
  ...
  useEffect(() => {
    ...
    logger.error('Application error:', error, { component: 'error', action: 'execution' });
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-500 via-orange-500 to-yellow-500">
      <div className="text-center p-8 bg-gray-900 rounded-2xl shadow-2xl max-w-md">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <Link
            href="/"
            className="px-6 py-3 bg-gray-700 text-white rounded-lg font-medium hover:opacity-90 transition-opacity"
          >
            Go Home
          </Link>
        </div>
