    ...
    <div className="min-h-screen bg-gray-900 overflow-x-hidden">
      ...
      <main>
        ...
        <section className="relative pt-24 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="absolute inset-0 -z-10 bg-[radial-gradient(45%_45%_at_50%_0%,rgba(249,115,22,0.1),transparent)] bg-[radial-gradient(45%_45%_at_50%_0%,rgba(234,88,12,0.05),transparent)]" />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-900/30 text-orange-300 text-sm font-medium mb-8">
