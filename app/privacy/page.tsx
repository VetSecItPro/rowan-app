        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8 p-6 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
            ...
            <div className="text-gray-700 dark:text-gray-300 space-y-1">
              ...
              <p>United States</p>
              <p>Email: <a href="mailto:privacy@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">privacy@rowan.app</a></p>
            </div>
            <p className="text-gray-700 dark:text-gray-300 mt-4">
              ...
              please contact us at <a href="mailto:privacy@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">privacy@rowan.app</a>.
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Legal Basis for Processing (GDPR)</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Contract Performance (Article 6(1)(b) GDPR)</h4>
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Legitimate Interests (Article 6(1)(f) GDPR)</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-2">
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Consent (Article 6(1)(a) GDPR)</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-2">
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Legal Obligation (Article 6(1)(c) GDPR)</h4>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">AI and Automated Processing</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Recipe Import (Google Gemini AI)</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Receipt Scanning (Google Gemini AI)</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Third-Party Service Providers (Data Processors)</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                <thead className="bg-gray-100 dark:bg-gray-800">
                  <tr>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Provider</th>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Purpose</th>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Location</th>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Data Processed</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Supabase</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Database & Authentication</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">United States</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">All user data, content, auth tokens</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Vercel</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Web Hosting & CDN</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Global (US primary)</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Request logs, IP addresses</td>
                  </tr>
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Stripe</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Payment Processing</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">United States</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Payment info, billing address</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Resend</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Transactional Emails</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">United States</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Email address, name</td>
                  </tr>
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Google (Gemini AI)</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">AI Features (Recipe/Receipt)</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">United States</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Content sent for AI processing only</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Upstash</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Rate Limiting & Caching</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">United States</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">IP addresses, request counts</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              <a href="mailto:privacy@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">privacy@rowan.app</a>.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              <Link href="/security" className="text-purple-600 dark:text-purple-400 hover:underline">Security page</Link>.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                <thead className="bg-gray-100 dark:bg-gray-800">
                  <tr>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Data Type</th>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Retention Period</th>
                    <th className="px-4 py-2 text-left text-gray-900 dark:text-white">Reason</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Account & Profile Data</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Until account deletion + 30 days</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Service provision, recovery period</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">User Content (tasks, events, etc.)</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Until account deletion + 30 days</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Service provision, recovery period</td>
                  </tr>
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Payment Records</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">7 years after transaction</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Tax and legal compliance</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Security/Audit Logs</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">90 days</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Security monitoring, incident response</td>
                  </tr>
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Analytics Data</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">30 days (aggregated indefinitely)</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Service improvement</td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Support Communications</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">2 years after resolution</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Quality assurance, dispute resolution</td>
                  </tr>
                  <tr className="bg-white dark:bg-gray-900">
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Marketing Consent Records</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Until withdrawal + 3 years</td>
                    <td className="px-4 py-2 text-gray-700 dark:text-gray-300">Compliance proof</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white">Right of Access</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Request a copy of the personal data we hold about you</p>
              </div>
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white">Right to Rectification</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Request correction of inaccurate or incomplete data</p>
              </div>
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white">Right to Erasure ("Right to be Forgotten")</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Request deletion of your personal data</p>
              </div>
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white">Right to Data Portability</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Receive your data in a structured, machine-readable format (JSON, CSV)</p>
              </div>
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white">Right to Object</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Object to processing based on legitimate interests or for direct marketing</p>
              </div>
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-white">Right to Restrict Processing</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Request that we limit how we use your data</p>
              </div>
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
              ...
              <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  ...
                  <a href="https://edpb.europa.eu/about-edpb/about-edpb/members_en" target="_blank" rel="noopener noreferrer" className="text-purple-600 dark:text-purple-400 hover:underline">
                    edpb.europa.eu
                  </a>.
                </p>
              </div>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
              <li>Email us at <a href="mailto:privacy@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">privacy@rowan.app</a></li>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Essential Cookies (Required)</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Analytics Cookies (Optional)</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-none text-gray-700 dark:text-gray-300 space-y-2">
              <li><strong>Privacy Inquiries:</strong> <a href="mailto:privacy@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">privacy@rowan.app</a></li>
              <li><strong>General Support:</strong> <a href="mailto:support@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">support@rowan.app</a></li>
              <li><strong>Security Issues:</strong> <a href="mailto:security@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">security@rowan.app</a></li>
            </ul>
            <p className="text-gray-700 dark:text-gray-300 mt-4">
