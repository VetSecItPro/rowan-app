    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="bg-gradient-to-b from-white via-purple-50/30 to-purple-100/50 dark:from-black dark:via-purple-950/20 dark:to-purple-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Your family's data deserves the highest level of protection</p>

        <div className="prose dark:prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Our Security Commitment</h2>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Encryption in Transit</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Encryption at Rest</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Password Protection</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Hosting and Cloud Security</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Network Security</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Data Backups</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">User Authentication</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Employee Access</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Space Permissions</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Security Monitoring</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Incident Response</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Vulnerability Management</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Standards and Regulations</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Development Practices</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Best Practices</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">What to Avoid</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Transparency and Communication</h2>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Security Updates</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Third-Party Services</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              <li>Email us at <a href="mailto:security@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">security@rowan.app</a></li>
            ...
            <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Note:</strong> For non-security support issues, please contact <a href="mailto:support@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">support@rowan.app</a>
              </p>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Questions?</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Have questions about our security practices? We're happy to provide more information:
            </p>
            <ul className="list-none text-gray-700 dark:text-gray-300 space-y-2">
              <li>Security inquiries: <a href="mailto:security@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">security@rowan.app</a></li>
              <li>General support: <a href="mailto:support@rowan.app" className="text-purple-600 dark:text-purple-400 hover:underline">support@rowan.app</a></li>
