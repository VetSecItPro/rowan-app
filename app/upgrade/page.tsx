...
export default function UpgradePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-gray-50 to-slate-100 dark:from-gray-900 dark:via-black dark:to-gray-950">
      {/* Hero Section */}
      <div className="max-w-4xl mx-auto px-4 py-16">
        {/* Badge */}
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-full">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 shadow-xl">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Family Spaces</h3>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 shadow-xl">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">All Features</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/50 shadow-xl">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Your Data Safe</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="p-8">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Unlimited tasks and events</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Multiple family spaces</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Real-time collaboration</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Early access to new features</p>
                </div>
              </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex items-center justify-center gap-2">
            <div className="flex -space-x-2">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-pink-500 border-2 border-white dark:border-gray-900" />
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 border-2 border-white dark:border-gray-900" />
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-red-500 border-2 border-white dark:border-gray-900" />
            </div>
