      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="p-8 space-y-8">
            ...
            {/* CCPA Information */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Your CCPA Rights</h2>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">What "Sale" Means</h4>
                ...
                <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Our Current Practice</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            {!user ? (
              ...
              <section className="text-center py-12">
                ...
                <p className="text-gray-600 dark:text-gray-400">Loading your CCPA preferences...</p>
              </section>
            ) : (
              <>
                ...
                <section>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">California Residency</h2>
                  </div>
                ...
                {californiaResident === true && (
                  <section>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Opt-Out Settings</h2>
                ...
                {californiaResident === false && (
                  <section>
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">CCPA Rights Not Applicable</h3>
            ...
            <section className="border-t border-gray-200 dark:border-gray-700 pt-8">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <h4 className="font-medium text-gray-900 dark:text-white mb-2">Contact for CCPA Requests</h4>
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <h4 className="font-medium text-gray-900 dark:text-white mb-2">Additional Resources</h4>
                  <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <a href="/privacy-policy" className="block hover:text-blue-600 dark:hover:text-blue-400">Privacy Policy</a>
                    <a href="/terms" className="block hover:text-blue-600 dark:hover:text-blue-400">Terms of Service</a>
                    <a href="/settings/privacy" className="block hover:text-blue-600 dark:hover:text-blue-400">Privacy Settings</a>
                  </div>
                </div>
              </div>
