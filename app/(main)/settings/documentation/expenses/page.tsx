    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="mb-12 p-8 bg-gradient-to-br from-red-900/20 to-red-800/20 rounded-2xl border border-red-800">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">AI Receipt Scanning</h3>
            <p className="text-sm text-gray-400">Automatic data extraction from receipt photos</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Spending Analytics</h3>
            <p className="text-sm text-gray-400">Track patterns and categorize expenses</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Budget Integration</h3>
            <p className="text-sm text-gray-400">Connect expenses to budget tracking</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            ...
            <h3 className="font-semibold text-white mb-2">Camera Receipt Scanning</h3>
            <p className="text-sm text-gray-400">Take photos to instantly extract expense data</p>
          </div>
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <Scan className="w-8 h-8 text-blue-500 mb-3" />
            <h3 className="font-semibold text-white mb-2">OCR Technology</h3>
            <p className="text-sm text-gray-400">AI-powered text recognition for accurate data extraction</p>
          </div>
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <DollarSign className="w-8 h-8 text-green-500 mb-3" />
            <h3 className="font-semibold text-white mb-2">Automatic Categorization</h3>
            <p className="text-sm text-gray-400">Smart category suggestions based on merchant data</p>
          </div>
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <TrendingUp className="w-8 h-8 text-purple-500 mb-3" />
            <h3 className="font-semibold text-white mb-2">Spending Analytics</h3>
            <p className="text-sm text-gray-400">Detailed insights into spending patterns</p>
          </div>
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <Calendar className="w-8 h-8 text-indigo-500 mb-3" />
            <h3 className="font-semibold text-white mb-2">Date Recognition</h3>
            <p className="text-sm text-gray-400">Automatically extract and parse receipt dates</p>
          </div>
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <FileText className="w-8 h-8 text-yellow-500 mb-3" />
            <h3 className="font-semibold text-white mb-2">Export & Reporting</h3>
            <p className="text-sm text-gray-400">Export data for taxes and accounting purposes</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-12 p-6 bg-gradient-to-br from-purple-900/20 to-purple-800/20 rounded-2xl border border-purple-800">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">🤖 AI-Powered Receipt Processing</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {section.articles.map((article) => (
                        <a
                          key={article.title}
                          href={article.href}
                          className="group p-6 bg-gray-800 rounded-2xl border border-gray-700 hover:shadow-lg hover:border-red-600 transition-all duration-200 hover:-translate-y-1"
                        >
                          <h3 className="font-semibold text-white mb-3 group-hover:text-red-400 transition-colors">
                            {article.title}
                          </h3>
          ...
          <div className="mt-16 space-y-16">
            ...
            <section id="understanding-expenses" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Understanding Expense Tracking</h2>
              </div>
            ...
            <section id="setup-scanning" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Setting Up Receipt Scanning</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Camera Permissions</h3>
            ...
            <section id="first-expense" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Creating Your First Expense</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="camera-scanning" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Camera Receipt Scanning</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="file-upload" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">File Upload Scanning</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Already have receipt photos saved on your device? Upload them directly for AI processing without taking a new photo.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Supported File Types</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="ai-extraction" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">AI Data Extraction</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                ...
                <div className="mt-6 p-4 bg-purple-900/20 rounded-xl border border-purple-800">
            ...
            <section id="receipt-correction" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Receipt Correction</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="supported-receipts" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Supported Receipt Types</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Our AI works with a wide variety of receipt formats from around the world.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Works Best With</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Limited Support</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="manual-entry" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Manual Expense Entry</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="expense-editing" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Expense Editing & Deletion</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Made a mistake or need to update an expense? Editing is simple and changes sync immediately.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">How to Edit</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-400">
            ...
            <section id="expense-search" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Expense Search & Filtering</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="expense-attachments" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Expense Attachments</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Keep your receipt images attached to expenses for easy reference and tax documentation.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Why Attach Receipts</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="spending-analytics" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Spending Analytics Dashboard</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Your spending analytics dashboard gives you a comprehensive view of where your money goes.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Dashboard Metrics</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="category-breakdown" className="scroll-mt-24">
              ...
              <div className="prose prose-gray prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Understanding the Charts</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="period-reports" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Monthly & Yearly Reports</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="spending-trends" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Spending Trends</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Trend analysis helps you identify patterns in your spending over time.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">What Trends Reveal</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="budget-integration" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Budget Integration</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Connect your expenses to budget tracking for comprehensive financial management.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">How Integration Works</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="bulk-operations" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Bulk Expense Operations</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Save time by editing or organizing multiple expenses at once.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Bulk Actions Available</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="expense-export" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Expense Export</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Export your expense data for tax preparation, accounting software, or personal records.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Export Formats</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="receipt-storage" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Receipt Storage & Organization</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  All your receipt images are securely stored and organized alongside your expense records.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Storage Benefits</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="tax-preparation" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Tax Preparation</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="family-tracking" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Family Expense Tracking</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Track expenses across all family members in your shared space for complete financial visibility.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">How Family Tracking Works</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
            ...
            <section id="expense-approval" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Expense Approval Workflow</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section id="shared-scanning" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Shared Receipt Scanning</h2>
              </div>
              <div className="prose prose-gray prose-invert max-w-none">
                <p className="text-gray-400 leading-relaxed mb-4">
                  Any family member can scan receipts that get added to the shared expense record.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6 mb-3">Family Scanning Benefits</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-400">
