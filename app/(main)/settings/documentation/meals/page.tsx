      ...
      <div className="mb-8">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <Link
            ...
            className="inline-flex items-center gap-2 py-2 px-3 text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 mb-6"
          >
        ...
        <div className="mt-12 space-y-12 scroll-smooth">
          ...
          <section id="intro" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">What is Meal Planning?</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Benefits of Using Rowan for Meal Planning</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <a href="#" className="inline-flex items-center gap-2 text-orange-600 dark:text-orange-400 hover:underline mt-6">
                Back to Top ↑
              </a>
            </div>
          </section>
          ...
          <section id="views" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Recipes View</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="quick-start" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Planning Your First Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Adding a Recipe to Your Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Creating a Shopping List</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="create-meal" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Opening the New Meal Form</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Filling Out Meal Details</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Linking a Recipe (Optional)</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Saving Your Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="link-recipes" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Why Link Recipes?</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Linking When Creating a Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Linking to an Existing Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Changing a Linked Recipe</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="edit-meals" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Editing a Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Deleting a Single Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Deleting Multiple Meals</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
                <li>Click the Select button at the top of the page</li>
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Undoing a Delete</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="past-meals" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Understanding Past Meal Indicators</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Showing Past Meals in List View</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Viewing Past Meals in Calendar View</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Reusing Past Meals</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="add-recipe" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Opening the Recipe Form</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Entering Basic Recipe Information</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Adding Ingredients</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Adding Instructions</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Saving Your Recipe</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
                <li>Review all the information you entered</li>
          ...
          <section id="discover-recipes" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Opening Recipe Discovery</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Searching for Specific Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Browsing by Cuisine</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Viewing Recipe Details</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Saving Discovered Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="ai-import" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">When to Use AI Import</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Importing from Text</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Importing from an Image</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Reviewing AI Results</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="organize-recipes" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Viewing All Your Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Searching Your Recipe Collection</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Editing Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Deleting Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="plan-from-recipe" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Using the Plan Meal Button</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Planning While Discovering Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Planning Multiple Meals from One Recipe</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="generate-list" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Generating a List from One Meal</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Understanding What Gets Added</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">What Happens to Meals Without Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="review-ingredients" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Reviewing the Ingredient List</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Selecting Which Ingredients to Add</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Adding Selected Items to Shopping List</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Canceling Without Adding</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="bulk-shopping" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Entering Selection Mode</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
                <li>Look at the top of the meal planning page</li>
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Selecting Multiple Meals</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Generating the Combined List</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Handling Duplicate Ingredients</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Exiting Selection Mode</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="keyboard" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Creating and Adding Content</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Switching Between Views</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Searching Quickly</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Closing Modals and Dialogs</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Keyboard Shortcut Tips</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="bulk-ops" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">What is Select Mode?</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Activating Select Mode</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Selecting Meals</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Generating Shopping Lists in Bulk</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Exiting Select Mode</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="search" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Using the Search Bar</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
                <li>Look at the top of the meal planning page</li>
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Searching in Calendar and List Views</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Searching in Recipes View</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Clearing Search Results</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="calendar-nav" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Switching Calendar Modes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Navigating Forward and Backward</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Jumping to Today</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Understanding the Calendar Display</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Choosing the Right View Mode</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="weekly-strategy" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">When to Plan Your Week</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Planning Your Meals</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Creating Your Shopping List</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Balancing Your Meal Plan</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Staying Flexible</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="build-collection" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Starting Your Collection</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Discovering New Recipes</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Organizing by Category</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Trying Before Committing</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Balancing Your Collection</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Using Your Collection</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="meal-prep" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">What is Meal Prep?</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Planning Meals for Batch Cooking</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Using Rowan for Meal Prep Planning</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Organizing Your Prep Day</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Batch Cooking Strategy</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Tracking What You Prepped</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <section id="collaborative" className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">How Rowan Supports Collaboration</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Planning Together</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Dividing Responsibilities</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Handling Different Preferences</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Communication Tips</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Building a Shared Recipe Collection</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
