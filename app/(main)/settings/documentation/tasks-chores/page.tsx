      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-8">
        ...
        <div className="mt-12 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 space-y-12 border border-gray-200 dark:border-gray-700">
          ...
          <section id="intro" className="scroll-mt-24">
            ...
            <a href="#" className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium mt-6">
              ↑ Back to top
            </a>
          </section>

          <section id="tasks-vs-chores" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Tasks vs Chores - What's the Difference?</h2>
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
                <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 mb-4"><strong>Use for one-time activities and projects</strong></p>
                  ...
                  <div className="mt-4 p-3 bg-white dark:bg-gray-800 rounded-lg">
                    <p className="text-xs text-gray-600 dark:text-gray-400"><strong>Example:</strong> "Buy birthday gift for Mom" - happens once, has a deadline</p>
                  </div>
                </div>
                ...
                <div className="p-6 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Chores</h3>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 mb-4"><strong>Use for recurring household duties</strong></p>
                  <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                  ...
                  <div className="mt-4 p-3 bg-white dark:bg-gray-800 rounded-lg">
                    <p className="text-xs text-gray-600 dark:text-gray-400"><strong>Example:</strong> "Take out trash" - repeats every week, rotates between family members</p>
                  </div>
                </div>
              </div>
          ...
          <section id="first-task" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Creating Your First Task</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="first-chore" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Creating Your First Chore</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="status-indicators" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Understanding Status Indicators</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
                <div className="p-6 bg-red-50 dark:bg-red-900/20 rounded-xl border-2 border-red-200 dark:border-red-800">
                  <div className="flex items-center justify-center mb-4">
                    <div className="w-12 h-12 rounded border-2 border-red-500 bg-red-100 dark:bg-red-900/40"></div>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-2">Pending</h3>
                  <p className="text-center text-gray-700 dark:text-gray-300 text-sm">
                    <strong className="text-red-600 dark:text-red-400">Red checkbox</strong><br/>
                ...
                <div className="p-6 bg-amber-50 dark:bg-amber-900/20 rounded-xl border-2 border-amber-200 dark:border-amber-800">
                  <div className="flex items-center justify-center mb-4">
                    <div className="w-12 h-12 rounded border-2 border-amber-500 bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center">
                      <div className="w-6 h-1 bg-amber-500"></div>
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-2">In Progress</h3>
                  <p className="text-center text-gray-700 dark:text-gray-300 text-sm">
                    <strong className="text-amber-600 dark:text-amber-400">Amber checkbox</strong><br/>
                ...
                <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border-2 border-green-200 dark:border-green-800">
                  <div className="flex items-center justify-center mb-4">
                    <div className="w-12 h-12 rounded border-2 border-green-500 bg-green-100 dark:bg-green-900/40 flex items-center justify-center">
                      <CheckSquare className="w-8 h-8 text-green-600" />
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-2">Completed</h3>
                  <p className="text-center text-gray-700 dark:text-gray-300 text-sm">
                    <strong className="text-green-600 dark:text-green-400">Green checkmark</strong><br/>
                    Finished! Task is done and checked off
                  </p>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">How to Change Status</h3>
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg mb-4">
                <span className="text-gray-700 dark:text-gray-300">Pending (red)</span>
                <span className="text-gray-400">→</span>
                <span className="text-gray-700 dark:text-gray-300">In Progress (amber)</span>
                <span className="text-gray-400">→</span>
                <span className="text-gray-700 dark:text-gray-300">Completed (green)</span>
                <span className="text-gray-400">→</span>
                <span className="text-gray-700 dark:text-gray-300">Pending (red)</span>
              </div>
          ...
          <section id="create-edit-tasks" className="scroll-mt-24">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Creating New Tasks</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Editing Existing Tasks</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">What You Can Edit</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Basic Fields</h4>
          ...
          <section id="status-management" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Status Management with Colored Checkboxes</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                The colored checkbox system is designed for speed and clarity. Here's everything you can do:
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Single Task Status Change</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Status Filtering</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-3">
                Use the filter bar to view tasks by status:
              </p>
              <div className="flex flex-wrap gap-3 my-4">
                <span className="px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-lg text-gray-700 dark:text-gray-300 text-sm font-medium">
                  All Tasks
                </span>
                <span className="px-4 py-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-red-700 dark:text-red-300 text-sm font-medium">
                  Pending Only
                </span>
                <span className="px-4 py-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg text-amber-700 dark:text-amber-300 text-sm font-medium">
                  In Progress Only
                </span>
                <span className="px-4 py-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-green-700 dark:text-green-300 text-sm font-medium">
                  Completed Only
                </span>
              </div>
          ...
          <section id="priorities" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Setting Priorities</h2>
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div className="p-5 bg-red-50 dark:bg-red-900/20 rounded-xl border-l-4 border-red-500">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">🔴</span>
                    <h3 className="text-xl font-bold text-red-700 dark:text-red-300">Urgent Priority</h3>
                  </div>
                ...
                <div className="p-5 bg-orange-50 dark:bg-orange-900/20 rounded-xl border-l-4 border-orange-500">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">🟠</span>
                    <h3 className="text-xl font-bold text-orange-700 dark:text-orange-300">High Priority</h3>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 mb-2">
                ...
                <div className="p-5 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border-l-4 border-yellow-500">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">🟡</span>
                    <h3 className="text-xl font-bold text-yellow-700 dark:text-yellow-300">Medium Priority</h3>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 mb-2">
                ...
                <div className="p-5 bg-green-50 dark:bg-green-900/20 rounded-xl border-l-4 border-green-500">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">🟢</span>
                    <h3 className="text-xl font-bold text-green-700 dark:text-green-300">Low Priority</h3>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 mb-2">
          ...
          <section id="due-dates" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Due Dates & Overdue Tracking</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Due dates help keep tasks on track with automatic visual warnings for overdue items.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Setting Due Dates</h3>
              <ol className="space-y-2 text-gray-700 dark:text-gray-300">
              ...
              <div className="space-y-3 my-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  <p className="text-gray-700 dark:text-gray-300">
                    <strong className="text-blue-700 dark:text-blue-300">📅 Future Due Date:</strong> Shows as regular text with calendar icon
                  </p>
                ...
                <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  <p className="text-gray-700 dark:text-gray-300">
                    <strong className="text-yellow-700 dark:text-yellow-300">⚠️ Due Soon (Today):</strong> Highlighted in amber/yellow
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                ...
                <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                  <p className="text-gray-700 dark:text-gray-300">
                    <strong className="text-red-700 dark:text-red-300">🚨 Overdue:</strong> Red badge with days overdue count
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          ...
          <section id="categories" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Task Categories & Tags</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 my-4">
                ...
                <div className="p-3 bg-green-100 dark:bg-green-900/30 rounded-lg text-center">
                  <span className="text-green-700 dark:text-green-300 font-semibold">💼 Work</span>
                </div>
                <div className="p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg text-center">
                  <span className="text-purple-700 dark:text-purple-300 font-semibold">🛒 Errands</span>
                </div>
                <div className="p-3 bg-pink-100 dark:bg-pink-900/30 rounded-lg text-center">
                  <span className="text-pink-700 dark:text-pink-300 font-semibold">👨‍👩‍👧‍👦 Family</span>
                </div>
                <div className="p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg text-center">
                  <span className="text-yellow-700 dark:text-yellow-300 font-semibold">💰 Finance</span>
                </div>
                <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-center">
                  <span className="text-red-700 dark:text-red-300 font-semibold">🏥 Health</span>
                </div>
                <div className="p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg text-center">
                  <span className="text-indigo-700 dark:text-indigo-300 font-semibold">🎯 Personal</span>
                </div>
                <div className="p-3 bg-orange-100 dark:bg-orange-900/30 rounded-lg text-center">
                  <span className="text-orange-700 dark:text-orange-300 font-semibold">🚗 Auto</span>
                </div>
              </div>
          ...
          <section id="drag-drop" className="scroll-mt-24">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">How to Reorder Tasks</h3>
              <ol className="space-y-3 text-gray-700 dark:text-gray-300">
          ...
          <section id="delete-tasks" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Deleting Tasks</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Remove tasks you no longer need with confirmation prompts to prevent accidents.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Delete Single Task</h3>
              <ol className="space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section id="access-details" className="scroll-mt-24">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Opening the Details Panel</h3>
              <ol className="space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                  <h4 className="font-semibold text-green-700 dark:text-green-300 mb-2">✓ Complete Task</h4>
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  <h4 className="font-semibold text-blue-700 dark:text-blue-300 mb-2">💤 Snooze Task</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">👤 Assign Member</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="p-4 bg-pink-50 dark:bg-pink-900/20 rounded-lg border border-pink-200 dark:border-pink-800">
                  <h4 className="font-semibold text-pink-700 dark:text-pink-300 mb-2">💬 Add Comment</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section id="time-tracking" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Time Tracking</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Track how long tasks actually take to improve planning and productivity.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Using the Timer</h3>
              <ol className="space-y-3 text-gray-700 dark:text-gray-300">
          ...
          <section id="subtasks" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Subtasks & Breakdown</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Break complex tasks into smaller, manageable steps with individual checkboxes.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Creating Subtasks</h3>
              <ol className="space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section id="comments" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Comments & Collaboration</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Use comments to discuss tasks, ask questions, and communicate with your household.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Adding Comments</h3>
              <ol className="space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section id="calendar-sync" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Calendar Sync</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Link tasks to your calendar for a unified view. Changes sync both ways automatically.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Enabling Calendar Sync</h3>
              <ol className="space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section id="create-chores" className="scroll-mt-24">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Common Household Chores</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 my-4">
                <div className="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg text-center text-sm">
                  🗑️ Take out trash
                </div>
                <div className="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg text-center text-sm">
                  🚿 Clean bathrooms
          ...
          <section id="chore-rotation" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Chore Rotation Setup</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Automatic rotation ensures fair distribution of household duties. Set it once, forget it forever.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Rotation Options</h3>
              <div className="space-y-4 my-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  <h4 className="font-semibold text-blue-700 dark:text-blue-300 mb-2">🔄 Round Robin</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">🎲 Random</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section id="round-robin" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Round Robin Rotation</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="p-5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl my-4">
                <p className="text-gray-700 dark:text-gray-300 mb-3"><strong>Example: "Take out trash" (Weekly)</strong></p>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section id="random-assignment" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Random Assignment</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="rotation-intervals" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Rotation Intervals</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">📅 Daily</h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">New person every day (e.g., "Feed pets", "Dishes")</p>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">📆 Weekly</h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">New person every week (e.g., "Trash", "Vacuum")</p>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">🗓️ Bi-weekly</h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">New person every 2 weeks (e.g., "Clean bathrooms")</p>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">📊 Monthly</h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">New person every month (e.g., "Deep clean", "Yard work")</p>
                </div>
              </div>
            </div>
            <a href="#" className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium mt-6">
          ...
          <section id="chore-completion" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Chore Completion Tracking</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-4">
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg text-center">
                  <div className="text-3xl font-bold text-amber-600 dark:text-amber-400 mb-1">5</div>
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-center">
                  <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">45</div>
          ...
          <section id="pending-indicator" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Pending Tasks Indicator</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="progress-tracking" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">In Progress Tracking</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="completion-percentage" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Completion Percentage</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="monthly-overview" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Monthly Overview</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="status-filter" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Status Filtering</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="tabs" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Task vs Chore Tabs</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="item-count" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Combined Task Count</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="calendar-integration" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Calendar Integration</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="meal-plan-tasks" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Meal Plan Task Automation</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="recipe-chain" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Recipe to Shopping to Task Chain</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="assign-tasks" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Assigning Tasks</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="communication" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Comments & Communication</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="member-rotation" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Chore Rotation Among Members</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="touch-gestures" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Touch Gestures for Drag & Drop</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="dark-mode" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Dark Mode Support</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="accessibility" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Screen Reader Support</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="break-down-tasks" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Breaking Down Large Tasks</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="daily-routine" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Daily Task Review Routine</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="chore-distribution" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Household Chore Distribution</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section id="time-tracking-tips" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Time Tracking for Productivity</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <div className="text-center text-gray-600 dark:text-gray-400 pt-8 border-t border-gray-200 dark:border-gray-700">
            <p>Need more help? Check out other <Link href="/settings/documentation" className="inline-block py-2 px-3 text-blue-600 dark:text-blue-400 hover:underline">documentation guides</Link></p>
          </div>
        </div>
