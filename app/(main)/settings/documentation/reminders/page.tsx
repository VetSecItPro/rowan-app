    ...
    <div className="min-h-screen bg-black p-4 sm:p-8">
        ...
        <div className="mt-12 bg-gray-800 rounded-2xl shadow-lg p-8 space-y-12 border border-gray-700">
          ...
          <section id="categories" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Categories & Priorities</h2>
            <div className="prose prose-invert max-w-none">
              <h3 className="text-xl font-semibold text-white mb-3">The 5 Reminder Categories</h3>
              <p className="text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6">
                <div className="p-4 bg-green-900/20 rounded-xl border border-green-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-bold text-white">Bills</h4>
                  </div>
                  <p className="text-sm text-gray-300">Financial reminders like utilities, rent, subscriptions, credit cards</p>
                </div>

                <div className="p-4 bg-red-900/20 rounded-xl border border-red-800">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-2xl">💊</span>
                    <h4 className="font-bold text-white">Health</h4>
                  </div>
                  <p className="text-sm text-gray-300">Medications, doctor appointments, prescriptions, wellness checks</p>
                </div>
                ...
                <div className="p-4 bg-blue-900/20 rounded-xl border border-blue-800">
                  ...
                  <p className="text-sm text-gray-300">Work deadlines, meetings, project milestones, professional commitments</p>
                </div>

                <div className="p-4 bg-purple-900/20 rounded-xl border border-purple-800">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-2xl">👤</span>
                    <h4 className="font-bold text-white">Personal</h4>
                  </div>
                  <p className="text-sm text-gray-300">Birthdays, anniversaries, personal goals, social events</p>
                </div>

                <div className="p-4 bg-amber-900/20 rounded-xl border border-amber-800">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-2xl">🏠</span>
                    <h4 className="font-bold text-white">Household</h4>
                  </div>
                  <p className="text-sm text-gray-300">Home maintenance, repairs, inspections, seasonal tasks</p>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-white mt-8 mb-3">Understanding Priority Levels</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-red-900/20 rounded-lg">
                  <span className="text-2xl">🔴</span>
                  <div>
                    <h4 className="font-semibold text-white">Urgent</h4>
                    <p className="text-sm text-gray-300">Time-sensitive, critical reminders that need immediate attention (medication due now, bill deadline today)</p>
                  </div>
                </div>

                <div className="flex items-start gap-3 p-3 bg-orange-900/20 rounded-lg">
                  <span className="text-2xl">🟠</span>
                  <div>
                    <h4 className="font-semibold text-white">High</h4>
                    <p className="text-sm text-gray-300">Important reminders that should be addressed soon (doctor appointment this week, upcoming bill)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-yellow-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">Standard reminders with some flexibility (schedule maintenance, plan event)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-green-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">Nice-to-have reminders with no urgency (consider renewal, check on something)</p>
                  </div>
                </div>
              </div>
          ...
          <section id="timing" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Setting Reminder Times</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Best Practices for Timing</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">✅ Do This</h4>
                ...
                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">❌ Avoid This</h4>
                  <ul className="space-y-1 text-sm text-gray-300">
          ...
          <section id="status" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Status Management</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
                <div className="p-6 bg-blue-900/20 rounded-xl border-2 border-blue-800">
                  <div className="flex items-center justify-center mb-4">
                    <Clock className="w-12 h-12 text-blue-600" />
                  </div>
                  <h3 className="text-xl font-bold text-white text-center mb-2">Active</h3>
                ...
                <div className="p-6 bg-amber-900/20 rounded-xl border-2 border-amber-800">
                  ...
                  <h3 className="text-xl font-bold text-white text-center mb-2">Snoozed</h3>
                  <p className="text-center text-gray-300 text-sm">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Changing Status</h3>
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Status Filters</h3>
              <p className="text-gray-300 mb-3">
                The filter bar lets you view reminders by status:
              </p>
              <div className="flex items-center gap-3 p-4 bg-gray-900 rounded-lg mb-4">
                <span className="px-3 py-1 bg-pink-500 text-white rounded-lg text-sm font-medium">All</span>
                <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-lg text-sm">Active</span>
                <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-lg text-sm">Snoozed</span>
                <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-lg text-sm">Completed</span>
              </div>
          ...
          <section id="assignment" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Assignment Filters</h3>
              <p className="text-gray-300 mb-3">
          ...
          <section id="comments" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Real-time Updates</h3>
              <p className="text-gray-300 mb-3">
                Comments sync in real-time across all devices. When your partner adds a comment, you see it immediately – no refresh needed!
              </p>

              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Use Cases for Comments</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-gray-900 rounded-lg">
          ...
          <section id="activity" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Activity Timeline</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
          ...
          <section id="repeat" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">The Three Repeat Options</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-purple-900/20 rounded-xl border border-purple-800">
                  ...
                  <div className="mt-3 mb-3">
                    <p className="text-xs text-gray-400 mb-2"><strong>Select days:</strong></p>
                    <div className="flex gap-2">
                      <span className="px-2 py-1 bg-pink-500 text-white rounded text-xs">Mon</span>
                      <span className="px-2 py-1 bg-gray-700 text-gray-300 rounded text-xs">Tue</span>
                      <span className="px-2 py-1 bg-pink-500 text-white rounded text-xs">Wed</span>
                      <span className="px-2 py-1 bg-gray-700 text-gray-300 rounded text-xs">Thu</span>
                ...
                <div className="p-4 bg-green-900/20 rounded-xl border border-green-800">
                  ...
                  <div className="mt-3 mb-3">
                    <p className="text-xs text-gray-400 mb-2"><strong>Select dates:</strong></p>
                    <div className="grid grid-cols-7 gap-1">
                      <span className="px-2 py-1 bg-pink-500 text-white rounded text-xs text-center">1</span>
                      <span className="px-2 py-1 bg-gray-700 text-gray-300 rounded text-xs text-center">2</span>
                      <span className="px-2 py-1 bg-gray-700 text-gray-300 rounded text-xs text-center">...</span>
          ...
          <section id="snooze" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Best Snooze Practices</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
          ...
          <section id="templates" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Quick Templates</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Available Templates</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">💊</span>
                    <h4 className="font-semibold text-white">Doctor Appointment</h4>
                  </div>
                  <p className="text-sm text-gray-300">Medical appointment reminder with health category and high priority</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">📞</span>
                    <h4 className="font-semibold text-white">Call Someone</h4>
                  </div>
                  <p className="text-sm text-gray-300">Reminder to make a phone call with personal category</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">💰</span>
                    <h4 className="font-semibold text-white">Pay Bill</h4>
                  </div>
                  <p className="text-sm text-gray-300">Recurring bill payment with bills category and high priority</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">💊</span>
                    <h4 className="font-semibold text-white">Take Medication</h4>
                  </div>
                  <p className="text-sm text-gray-300">Daily medication reminder with health category</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">🛒</span>
                    <h4 className="font-semibold text-white">Buy Groceries</h4>
                  </div>
                  <p className="text-sm text-gray-300">Grocery shopping reminder with household category</p>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-white mt-6 mb-3">How to Use Templates</h3>
              <ol className="space-y-3 text-gray-300">
                <li>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-blue-900/20 rounded-lg">
                  ...
                  <div>
                    <strong className="text-white">Reminder Due:</strong>
                    <p className="text-sm text-gray-300 mt-1">Browser notification at the scheduled time with reminder title and details</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-purple-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">Notified when someone assigns a reminder to you</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-pink-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">Instant alert when someone mentions you in a comment</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-red-900/20 rounded-lg">
                  ...
                  <div>
                    <strong className="text-white">Overdue Reminders:</strong>
                    <p className="text-sm text-gray-300 mt-1">Daily summary of reminders that passed their due time</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-green-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">Notified when someone comments on your reminders</p>
                  </div>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Notification Preferences</h3>
              <p className="text-gray-300 mb-3">
          ...
          <section id="bulk-complete" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">🏃 Morning Routine</h4>
                  <p className="text-sm text-gray-300">Complete all your morning medication reminders at once after taking them all</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">💼 Work Day End</h4>
                  <p className="text-sm text-gray-300">Mark all work reminders as done when you finish for the day</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">🏠 Weekend Cleanup</h4>
                  <p className="text-sm text-gray-300">Complete all household tasks you tackled during weekend chores</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">💰 Bill Payment Session</h4>
                  <p className="text-sm text-gray-300">Mark all bills as paid after a bill-paying session</p>
                </div>
              </div>
          ...
          <section id="bulk-edit" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Bulk Priority & Category Changes</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Available Bulk Edits</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-orange-900/20 rounded-lg">
                  <Flag className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <strong className="text-white">Change Priority:</strong>
                    <p className="text-sm text-gray-300 mt-1">Update priority for all selected (Urgent, High, Medium, Low)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-purple-900/20 rounded-lg">
                  ...
                  <div>
                    <strong className="text-white">Change Category:</strong>
                    <p className="text-sm text-gray-300 mt-1">Apply category to all selected (Bills, Health, Work, Personal, Household)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-blue-900/20 rounded-lg">
                  ...
                  <div>
                    <strong className="text-white">Assign To:</strong>
                    <p className="text-sm text-gray-300 mt-1">Assign all selected reminders to one person</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-red-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">Remove all selected reminders (with confirmation)</p>
                  </div>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Practical Scenarios</h3>
          ...
          <section id="export" className="scroll-mt-24">
            <h2 className="text-3xl font-bold text-white mb-4">Export to JSON/CSV</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">What Gets Exported</h3>
              <ul className="space-y-2 text-gray-300">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Why Export?</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">💾 Backup</h4>
                  <p className="text-sm text-gray-300">Keep a local copy of all your reminders for safekeeping</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">📊 Analysis</h4>
                  <p className="text-sm text-gray-300">Analyze patterns in spreadsheets (who completes most reminders?)</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">📋 Documentation</h4>
                  <p className="text-sm text-gray-300">Create reports for medical records or bill payment history</p>
                </div>

                <div className="p-4 bg-gray-900 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">🔄 Migration</h4>
                  <p className="text-sm text-gray-300">Move data to another system if needed</p>
                </div>
              </div>
          ...
          <section id="organizing" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Category Best Practices</h3>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-green-900/20 rounded-xl border border-green-800">
                  ...
                  <p className="text-xs text-gray-400 mt-3"><strong>Pro Tip:</strong> Set bill reminders for 2-3 days before due date with High priority</p>
                </div>
                ...
                <div className="p-4 bg-red-900/20 rounded-xl border border-red-800">
                  ...
                  <p className="text-xs text-gray-400 mt-3"><strong>Pro Tip:</strong> Use repeat patterns for daily medications, mark appointments as Urgent</p>
                </div>
                ...
                <div className="p-4 bg-blue-900/20 rounded-xl border border-blue-800">
                  ...
                  <p className="text-xs text-gray-400 mt-3"><strong>Pro Tip:</strong> Keep work separate from personal for better work-life balance visualization</p>
                </div>
                ...
                <div className="p-4 bg-purple-900/20 rounded-xl border border-purple-800">
                  ...
                  <p className="text-xs text-gray-400 mt-3"><strong>Pro Tip:</strong> Set birthday reminders for 1 week before so you have time to shop</p>
                </div>
                ...
                <div className="p-4 bg-amber-900/20 rounded-xl border border-amber-800">
                  ...
                  <p className="text-xs text-gray-400 mt-3"><strong>Pro Tip:</strong> Use monthly repeats for maintenance tasks like changing air filters</p>
                </div>
              </div>
          ...
          <section id="priorities" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div className="p-5 bg-red-900/20 rounded-xl border-2 border-red-700">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-3xl">🔴</span>
                    <h3 className="text-xl font-bold text-red-100">Urgent Priority</h3>
                  </div>
                  <p className="text-red-200 mb-3 font-semibold">Use for: Time-critical items that need immediate attention</p>
                  <ul className="space-y-1 text-sm text-red-200">
                  ...
                  <div className="mt-3 p-3 bg-gray-800 rounded-lg">
                    <p className="text-xs text-gray-300"><strong>⚠️ Warning:</strong> If everything is Urgent, nothing is. Reserve this for genuine emergencies and time-critical items only!</p>
                  </div>
                </div>

                <div className="p-5 bg-orange-900/20 rounded-xl border-2 border-orange-700">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-3xl">🟠</span>
                    <h3 className="text-xl font-bold text-orange-100">High Priority</h3>
                  </div>
                  <p className="text-orange-200 mb-3 font-semibold">Use for: Important items that should be handled soon</p>
                ...
                <div className="p-5 bg-yellow-900/20 rounded-xl border-2 border-yellow-700">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-3xl">🟡</span>
                    <h3 className="text-xl font-bold text-yellow-100">Medium Priority</h3>
                  </div>
                  <p className="text-yellow-200 mb-3 font-semibold">Use for: Standard reminders with some flexibility</p>
                  ...
                  <div className="mt-3 p-3 bg-gray-800 rounded-lg">
                    <p className="text-xs text-gray-300"><strong>💡 Tip:</strong> Medium is your default for most reminders. Things you want to do but have flexibility on timing.</p>
                  </div>
                </div>

                <div className="p-5 bg-green-900/20 rounded-xl border-2 border-green-700">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-3xl">🟢</span>
                    <h3 className="text-xl font-bold text-green-100">Low Priority</h3>
                  </div>
                  ...
                  <div className="mt-3 p-3 bg-gray-800 rounded-lg">
                    <p className="text-xs text-gray-300"><strong>🌟 Strategy:</strong> Low priority keeps future ideas on your radar without cluttering your active reminders. Review monthly and upgrade if they become more urgent!</p>
                  </div>
                </div>
              </div>
          ...
          <section id="template-workflow" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                ...
                <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                  <h4 className="font-semibold text-white mb-2">🎯 Skip Templates For</h4>
                  <ul className="space-y-1 text-sm text-gray-300">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Building Consistent Habits with Templates</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Template Customization Workflow</h3>
              <ol className="space-y-2 text-gray-300">
          ...
          <section id="overdue" className="scroll-mt-24">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Triage Strategy for Backlog</h3>
              <div className="space-y-3">
                <div className="p-4 bg-green-900/20 rounded-lg border border-green-800">
                  <h4 className="font-semibold text-green-100 mb-2">1️⃣ Do It Now (If Quick)</h4>
                  <p className="text-sm text-green-200">If the reminder takes less than 5 minutes, just do it and mark complete</p>
                </div>
                ...
                <div className="p-4 bg-amber-900/20 rounded-lg border border-amber-800">
                  <h4 className="font-semibold text-amber-100 mb-2">3️⃣ Delete (If No Longer Needed)</h4>
                  <p className="text-sm text-amber-200">That doctor appointment you never scheduled? Delete it or reschedule realistically</p>
                </div>

                <div className="p-4 bg-purple-900/20 rounded-lg border border-purple-800">
                  <h4 className="font-semibold text-purple-100 mb-2">4️⃣ Bulk Complete (If Done But Unmarked)</h4>
                  <p className="text-sm text-purple-200">Select all medications you took but forgot to mark – bulk complete them</p>
                </div>
              </div>
