          ...
          <div className="mt-20 max-w-4xl mx-auto space-y-16">
            ...
            <section id="understanding-recipes" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Understanding Recipe Library</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Three Ways to Build Your Library</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Library Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Shared vs. Personal Recipes</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
              ...
              <a href="#" className="inline-flex items-center gap-2 mt-6 text-yellow-600 dark:text-yellow-400 hover:underline text-sm font-medium">
                ← Back to top
              </a>
            </section>
            ...
            <section id="first-search" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Your First Recipe Search</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How to Search for Recipes</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Effective Search Tips</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Understanding Results</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="ai-import" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">AI Recipe Import</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How AI Import Works</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Powered by Google Gemini</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="external-apis" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">External API Search</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Recipe Sources</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Search Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Saving External Recipes</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="cuisine-filtering" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Cuisine & Category Filtering</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Cuisine Types</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Meal Categories</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Dietary Preferences</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="difficulty-filtering" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Difficulty & Time Filtering</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Difficulty Levels</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Time Ranges</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Combining Filters</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="random-suggestions" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Random Recipe Suggestions</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How to Get Suggestions</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Filtered Random</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Weekly Inspiration</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="trending-recipes" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Trending & Popular Recipes</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Trending Sections</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Why Try Trending Recipes</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="url-import" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">URL-Based Import</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Import Steps</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Best Practices</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="gemini-integration" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Google Gemini Integration</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How Gemini Processes Recipes</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">AI Capabilities</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="extraction-process" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Data Extraction Process</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Extraction Challenges</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-correction" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Correction</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What to Review</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Making Edits</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="supported-websites" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Supported Website Formats</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Best Results From</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">May Require More Editing</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Not Currently Supported</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-organization" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Organization</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Organization Methods</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Tagging Best Practices</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="library-search" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Search & Filtering</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Quick Access Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="favorite-recipes" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Favorite Recipes</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Favorites</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What to Favorite</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-rating" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Rating & Reviews</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Rating System</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Personal Notes</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-sharing" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Sharing</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Sharing Within Spaces</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Sharing Externally</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-builder" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Builder</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Builder Sections</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Tips for Great Recipes</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="ingredient-management" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Ingredient Management</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Ingredient Fields</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Ingredient Groups</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="instruction-steps" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Instruction Steps</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Writing Effective Steps</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Step Organization</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-photos" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Photos</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Photo Types</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Photo Tips</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="nutritional-info" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Nutritional Information</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Nutrition Fields</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Dietary Tags</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-to-meal" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe to Meal Conversion</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How to Plan a Recipe</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Benefits</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="shopping-generation" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Shopping List Generation</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Generation Options</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Smart Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="meal-prep" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Meal Prep Planning</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Meal Prep Strategies</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Good Prep Recipes</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-scaling" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Scaling</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How Scaling Works</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Scaling Considerations</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-collections" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Collections</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Collection Ideas</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Managing Collections</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="cooking-history" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Cooking History</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">History Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using History for Planning</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="recipe-analytics" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recipe Analytics</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Available Analytics</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Insights</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="import-export" className="scroll-mt-24">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Import Options</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
