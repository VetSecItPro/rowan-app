      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <Link
            ...
            className="inline-flex items-center gap-2 py-2 px-3 text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 mb-6"
          >
        ...
        <div className="mt-12 space-y-12">
          {/* Getting Started */}
          <section id="overview" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-4 rounded-r-lg">
                <p className="text-green-800 dark:text-green-200 font-medium mb-2">💡 Pro Tip:</p>
          ...
          <section id="conversations" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="space-y-3 text-gray-700 dark:text-gray-300">
                <li className="pl-2">
                  <strong className="text-gray-900 dark:text-white">1. Click the "+ New Conversation" button</strong> - You'll find this at the top of the Messages page or in the conversation sidebar.
                </li>
                <li className="pl-2">
                  <strong className="text-gray-900 dark:text-white">2. Give it a name</strong> - Choose something descriptive like "Family Chat," "Weekend Plans," or "Home Renovation."
                </li>
                <li className="pl-2">
                  <strong className="text-gray-900 dark:text-white">3. Add participants</strong> - Select family members you want to include. You can always add more people later!
                </li>
                <li className="pl-2">
                  <strong className="text-gray-900 dark:text-white">4. Start messaging!</strong> - That's it! Your conversation is ready to use.
                </li>
              </ol>
              <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded-r-lg mt-6">
                <p className="text-blue-800 dark:text-blue-200 font-medium mb-2">🎯 Quick Tip:</p>
          ...
          <section id="sending" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Send Options</h4>
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1 ml-4">
                    <li>• Press <kbd className="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded text-xs">Enter</kbd> to send (or click the Send button)</li>
                    <li>• Press <kbd className="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded text-xs">Shift + Enter</kbd> for a new line</li>
                    <li>• Use the emoji button 😊 to add reactions quickly</li>
                  </ul>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Receiving Messages</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section id="reactions" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">How to React:</h4>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 border-l-4 border-purple-500 p-4 rounded-r-lg">
                  <p className="text-purple-800 dark:text-purple-200 font-medium mb-2">✨ Fun Fact:</p>
          ...
          <section id="attachments" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Supported File Types:</h4>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg text-center">
                      <ImageIcon className="w-6 h-6 mx-auto mb-1 text-blue-600" />
                      <p className="text-xs text-gray-700 dark:text-gray-300">Images<br/>(JPG, PNG, GIF)</p>
                    </div>
                    <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg text-center">
                      <Paperclip className="w-6 h-6 mx-auto mb-1 text-red-600" />
                      <p className="text-xs text-gray-700 dark:text-gray-300">Documents<br/>(PDF, DOC, TXT)</p>
                    </div>
                    <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg text-center">
                      <Mic className="w-6 h-6 mx-auto mb-1 text-green-600" />
                      <p className="text-xs text-gray-700 dark:text-gray-300">Audio<br/>(MP3, WAV, M4A)</p>
                    </div>
                    <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg text-center">
                      <Paperclip className="w-6 h-6 mx-auto mb-1 text-purple-600" />
                      <p className="text-xs text-gray-700 dark:text-gray-300">Others<br/>(ZIP, CSV, etc.)</p>
                    </div>
                  </div>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">How to Attach Files:</h4>
                  <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 p-4 rounded-r-lg">
                  <p className="text-amber-800 dark:text-amber-200 font-medium mb-2">⚠️ File Size Limit:</p>
          ...
          <section id="voice" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Recording Voice Messages:</h4>
                  <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-4 rounded-r-lg">
                  <p className="text-green-800 dark:text-green-200 font-medium mb-2">🎯 Use Cases:</p>
          ...
          <section id="threads" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">How to Reply to a Message:</h4>
                  <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Viewing Thread Replies:</h4>
                ...
                <div className="bg-indigo-50 dark:bg-indigo-900/20 border-l-4 border-indigo-500 p-4 rounded-r-lg">
                  <p className="text-indigo-800 dark:text-indigo-200 font-medium mb-2">💡 Best Practice:</p>
          ...
          <section id="pinned" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">What to Pin:</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">How to Pin:</h4>
                  <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-pink-50 dark:bg-pink-900/20 border-l-4 border-pink-500 p-4 rounded-r-lg">
                  <p className="text-pink-800 dark:text-pink-200 font-medium mb-2">📌 Pro Tip:</p>
          ...
          <section id="mentions" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">How Mentions Work:</h4>
                  <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                    <li className="pl-2">1. Type <code className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">@</code> in your message</li>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">When to Use Mentions:</h4>
                  <ul className="space-y-2 text-gray-700 dark:text-gray-300 ml-4">
          ...
          <section id="search" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">How to Search:</h4>
                  <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-teal-50 dark:bg-teal-900/20 border-l-4 border-teal-500 p-4 rounded-r-lg">
                  <p className="text-teal-800 dark:text-teal-200 font-medium mb-2">🔍 Search Tips:</p>
                  <ul className="text-teal-700 dark:text-teal-300 text-sm space-y-1 ml-4">
          ...
          <section id="realtime" className="scroll-mt-8 bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">What's Real-Time?</h4>
                  <ul className="space-y-2 text-gray-700 dark:text-gray-300 ml-4">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded-r-lg">
                  <p className="text-blue-800 dark:text-blue-200 font-medium mb-2">⚡ How It Works:</p>
                  <p className="text-blue-700 dark:text-blue-300 text-sm">
