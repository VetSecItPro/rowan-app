          ...
          <div className="mb-12 max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-gray-200/60 dark:border-gray-700/60 rounded-2xl">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Earn Points</h3>
              ...
              {/* Browse Rewards */}
              <div className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 backdrop-blur-sm border-2 border-amber-300 dark:border-amber-700 rounded-2xl relative">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Browse Rewards</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-gray-200/60 dark:border-gray-700/60 rounded-2xl">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Redeem & Enjoy</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {section.articles.map((article, index) => (
                      <Link
                        key={index}
                        href={article.href}
                        className="group p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-gray-200/60 dark:border-gray-700/60 hover:border-amber-300 dark:hover:border-amber-600 rounded-2xl hover:shadow-lg hover:shadow-amber-500/20 transition-all duration-300 hover:-translate-y-1"
                      >
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <span className="text-xs font-medium text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 px-2 py-1 rounded-full whitespace-nowrap ml-3">
                            {article.readTime}
                          </span>
                        </div>
            ...
            <div className="p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-gray-200/60 dark:border-gray-700/60 rounded-2xl shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">1. Complete Tasks</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">2. Earn Points</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">3. Choose Rewards</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">4. Redeem & Enjoy</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="mt-20 space-y-16 max-w-4xl mx-auto">
            ...
            <section id="intro" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Introduction to Rewards Shop</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Why Use the Rewards System?</h3>
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg mt-6">
              ...
              <a href="#" className="inline-flex items-center gap-2 mt-6 text-amber-600 dark:text-amber-400 hover:underline text-sm font-medium">
                ← Back to top
              </a>
            </section>
            ...
            <section id="understanding-points" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Understanding Points</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Key Point Concepts</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Point Visibility</h3>
            ...
            <section id="roles" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Roles: Kids vs Parents</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Family Members (Kids)</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Parents/Admins</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <section id="navigating" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Navigating the Rewards Shop</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  The Rewards Shop is designed to be intuitive and fun. Here&apos;s a quick tour of the main interface elements:
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Points Display</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Rewards Catalog</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Leaderboard Widget</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Quick Actions</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="earning-chores" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Completing Chores for Points</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How It Works</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Task Assignment Matters</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <div className="p-4 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg mt-6">
            ...
            <section id="point-values" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Point Values & Multipliers</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Typical Point Ranges</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Point Multipliers</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="bonus-points" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Bonus Points & Streaks</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Beyond base task points, there are several ways to earn bonus points that accelerate your progress toward rewards.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Streak Bonuses</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Early Completion</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Achievement Bonuses</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="points-history" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Viewing Your Points History</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Tracking your point history helps you understand your earning patterns and celebrate your progress over time.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What&apos;s Tracked</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Viewing History</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="browsing-rewards" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Browsing Available Rewards</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Reward Cards</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Sorting & Filtering</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Reward Details</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="reward-tiers" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Understanding Reward Tiers</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Small Rewards (25-100 pts)</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Medium Rewards (100-300 pts)</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Worth saving up for a week or two: movie night with popcorn, new book or small toy, friend sleepover, or skip one chore day.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Large Rewards (300-1000 pts)</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="reward-categories" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Reward Categories</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Rewards can be organized into categories to help with browsing and to ensure variety in your family&apos;s catalog.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Common Categories</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <section id="reward-availability" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Checking Reward Availability</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Not all rewards are available all the time. Understanding availability helps you plan which rewards to save for.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Availability Types</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Availability Indicators</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="how-to-redeem" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">How to Redeem a Reward</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  When you&apos;ve earned enough points for a reward you want, redeeming is straightforward. Here&apos;s the step-by-step process:
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Redemption Steps</h3>
                <ol className="list-decimal list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Points Reservation</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="approval-process" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Redemption Approval Process</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Why Approval?</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Approval Timeline</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">If Denied</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="tracking-redemptions" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Tracking Your Redemptions</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  After submitting a redemption request, you can track its status through the approval and fulfillment process.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Redemption Statuses</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Where to Check</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="after-approval" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">What Happens After Approval</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Immediate Rewards</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Some rewards like screen time or privilege passes are available immediately after approval. You can claim them right away.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Scheduled Rewards</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Physical Rewards</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="creating-rewards" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Creating Custom Rewards</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Creating a New Reward</h3>
                <ol className="list-decimal list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Reward Ideas</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="setting-values" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Setting Point Values</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Balancing reward costs is crucial for a successful system. Prices should encourage saving while remaining achievable.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Pricing Guidelines</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Finding the Balance</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="managing-stock" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Managing Stock & Availability</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Some rewards shouldn&apos;t be unlimited. Stock and availability controls help manage special rewards appropriately.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Stock Limits</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Temporary Unavailability</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Editing Rewards</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="approving-redemptions" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Approving Redemptions</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  When kids request rewards, parents review and approve or deny them from the management interface.
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Reviewing Requests</h3>
                <ol className="list-decimal list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">When to Deny</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Marking as Fulfilled</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="leaderboard" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Viewing Family Leaderboard</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What&apos;s Shown</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Healthy Competition</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="faq" className="scroll-mt-24">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Can points expire?</h4>
                    <p className="text-gray-600 dark:text-gray-400">No, earned points don&apos;t expire. Kids can save as long as they want for bigger rewards.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Can kids transfer points to each other?</h4>
                    <p className="text-gray-600 dark:text-gray-400">Currently, points are personal and can&apos;t be transferred between family members.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">What happens if I delete a reward?</h4>
                    <p className="text-gray-600 dark:text-gray-400">Pending redemptions for that reward will need to be handled first. The reward can&apos;t be deleted while there are pending requests.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Can I adjust point values after kids have earned them?</h4>
                    <p className="text-gray-600 dark:text-gray-400">Changing task point values only affects future completions. Previously earned points remain unchanged.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Is the Rewards Shop available on the free plan?</h4>
                    <p className="text-gray-600 dark:text-gray-400">The Rewards Shop is a Family plan feature, designed specifically for households with children.</p>
                  </div>
                </div>
              </div>
              <a href="#" className="inline-flex items-center gap-2 mt-6 text-amber-600 dark:text-amber-400 hover:underline text-sm font-medium">
            ...
            <section id="missing-points" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Points Not Showing Up</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What to Do</h3>
                <ol className="list-decimal list-inside text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <section id="redemption-issues" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Redemption Issues</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  If you&apos;re having trouble with redemptions, here&apos;s how to resolve common issues:
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Stuck in Pending</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Denied Redemption</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Can&apos;t Find Redeem Button</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section id="best-practices" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Best Practices for Families</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Make the rewards system work well for your whole family with these proven strategies:
                </p>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">For Parents</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">For Kids</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                ...
                <div className="p-4 bg-teal-50 dark:bg-teal-900/30 border border-teal-200 dark:border-teal-800 rounded-lg mt-6">
