          ...
          <div className="mt-16 space-y-16">
            ...
            <section id="understanding-household" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Understanding Household Management</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Key Components</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Why Use Household Management?</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="first-budget" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Setting Up Your First Budget</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Step-by-Step Budget Setup</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Common Budget Categories</h3>
            ...
            <section id="creating-chores" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Creating Household Chores</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Creating a New Chore</h3>
                <ol className="list-decimal list-inside space-y-3 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Example Chores to Track</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="chore-status" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Chore Status System</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Changing Status</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="chore-assignment" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Chore Assignment & Rotation</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Manual Assignment</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Automatic Rotation</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="recurring-chores" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recurring Chores</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Recurrence Options</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How Recurring Chores Work</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="chore-calendar" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Chore Calendar Integration</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Calendar Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Setting Chore Reminders</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="expense-categories" className="scroll-mt-24">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Creating Custom Categories</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="budget-planning" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Monthly Budget Planning</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Creating a Monthly Budget</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Budget vs. Actual Tracking</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="expense-analytics" className="scroll-mt-24">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Analytics Effectively</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="budget-alerts" className="scroll-mt-24">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Alert Types</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Configuring Alerts</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="adding-bills" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Adding Bills</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Creating a New Bill</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Bill Details to Track</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="payment-tracking" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Bill Payment Tracking</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Marking Bills as Paid</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Payment History</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="bill-reminders" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Bill Reminders</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Reminder Options</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Setting Up Reminders</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="auto-expenses" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Auto-Expense Creation</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Configuration Options</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="chore-analytics" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Chore Analytics</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Analytics for Improvement</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="budget-reports" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Budget Reports</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Generating Reports</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="household-dashboard" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Household Dashboard</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Dashboard Widgets</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Customizing Your Dashboard</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="shared-responsibility" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Shared Responsibility</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Distribution Strategies</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Bill Responsibility</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="partner-notifications" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Partner Notifications</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Notification Types</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Notification Preferences</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="family-meetings" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Family Meetings</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Meeting Agenda Template</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Rowan in Meetings</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="smart-home" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Smart Home Integration</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Potential Integrations</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Future Possibilities</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="seasonal-planning" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Seasonal Planning</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Seasonal Chores</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Budget Adjustments</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="emergency-fund" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Emergency Fund Tracking</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Setting Up Emergency Fund Tracking</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Your Emergency Fund</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="multi-property" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Multi-Property Management</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Using Spaces for Properties</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Rental Property Considerations</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="irregular-income" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Handling Irregular Income</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Strategies for Variable Income</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Implementation in Rowan</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="family-motivation" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Motivating Family Members</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">For Partners</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">For Children</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="data-backup" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Data Recovery & Backup</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Automatic Protection</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Exporting Your Data</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="performance-tips" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Performance Optimization</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Data Management</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">App Performance</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
