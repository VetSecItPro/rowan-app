          ...
          <div className="mt-20 max-w-4xl mx-auto space-y-16">
            ...
            <section id="what-are-spaces" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">What are Spaces?</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Why Spaces Matter</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Default Personal Space</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
              ...
              <a href="#" className="inline-flex items-center gap-2 mt-6 text-teal-600 dark:text-teal-400 hover:underline text-sm font-medium">
                ← Back to top
              </a>
            </section>
            ...
            <section id="creating-space" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Creating Your First Space</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Create a Space</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Naming Best Practices</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">After Creating Your Space</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="roles-permissions" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Space Roles & Permissions</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="switching-spaces" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Switching Between Spaces</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How to Switch Spaces</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What Changes When You Switch</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Space Persistence</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="inviting-members" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Inviting Members to Your Space</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Invite Someone</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Choosing the Right Role</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Invitation Limits</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="accepting-invitations" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Accepting Space Invitations</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Accept an Invitation</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Important Requirements</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">After Accepting</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="managing-invitations" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Managing Pending Invitations</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Viewing Pending Invitations</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                  <li>Go to Settings → Space Settings</li>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Resending an Invitation</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Canceling an Invitation</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="invitation-security" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Invitation Security & Expiration</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Security Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Expiration Policy</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Best Security Practices</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="viewing-members" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Viewing Space Members</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Where to View Members</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Member Information Displayed</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Member Count</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="member-roles" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Member Roles & Responsibilities</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Owner Responsibilities</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Admin Responsibilities</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Member Responsibilities</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
            ...
            <section id="role-changes" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Promoting & Demoting Members</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Promoting a Member to Admin</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                  <li>Go to Settings → Space Settings</li>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Demoting an Admin to Member</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">When to Change Roles</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="removing-members" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Removing Members from Spaces</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Who Can Remove Whom</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Remove a Member</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                  <li>Go to Settings → Space Settings</li>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What Happens After Removal</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <div className="p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg mt-6">
            ...
            <section id="presence-indicators" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Understanding Presence Indicators</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Status Indicators</h3>
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-green-500"></div>
                    <div>
                      <span className="font-medium text-gray-900 dark:text-white">Online (Green)</span>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Active in the last 2 minutes</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-gray-400"></div>
                    <div>
                      <span className="font-medium text-gray-900 dark:text-white">Offline (Gray)</span>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Not currently active or away</p>
                    </div>
                  </div>
                </div>

                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Where You'll See Presence</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Practical Uses</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="activity-tracking" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Member Activity Tracking</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How Activity is Detected</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Battery Efficiency</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Activity Privacy</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="collaborative-features" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Collaborative Features</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Real-Time Updates</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Shared Features</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Working Together Efficiently</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="privacy-settings" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Privacy & Presence Settings</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Privacy by Design</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Controlling Your Visibility</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Data Protection</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="space-settings" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Space Settings Overview</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">How to Access Space Settings</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What You Can Manage</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Settings by Role</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="renaming-space" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Renaming Your Space</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Rename</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                  <li>Go to Settings → Space Settings</li>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Naming Tips</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Who Can Rename</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="leaving-space" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Leaving a Space</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Leave a Space</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What Happens When You Leave</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Owner Restrictions</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="deleting-space" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Deleting a Space (Owners Only)</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Before You Delete</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Steps to Delete a Space</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">What Gets Deleted</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="family-tips" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Family Collaboration Tips</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Setting Up Your Family Space</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Daily Routines</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Communication Tips</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Involving Children</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="team-strategies" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Team Organization Strategies</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Team Structure</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">For Roommates</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">For Project Groups</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Multiple Spaces Strategy</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <section id="security-guidelines" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Space Security Guidelines</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Invitation Security</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                  <li>Only invite people you know and trust</li>
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Member Management</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Account Security</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Data Awareness</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <section id="troubleshooting" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Troubleshooting Common Issues</h2>
              </div>
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Invitation Not Received</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Invitation Link Not Working</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Can't See Other Members' Content</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Presence Showing Incorrectly</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">Can't Leave or Delete Space</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
