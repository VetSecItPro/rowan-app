        ...
        <section id="intro" className="mt-16 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Why Daily Check-Ins Matter</h3>
              ...
              <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Heart className="w-5 h-5 text-pink-600 dark:text-pink-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-pink-900 dark:text-pink-100 mb-2">Partner Connection</p>
            ...
            <a href="#" className="inline-flex items-center gap-2 mt-8 text-pink-600 dark:text-pink-400 hover:underline">
              <ArrowLeft className="w-4 h-4" />
              Back to top
            </a>
          </div>
        ...
        <section id="first-checkin" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Step 1: Navigate to Check-In</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Step 2: Select Your Mood</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                You will see five mood options displayed as colorful cards:
              </p>
              <ul className="list-none space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Step 3: Answer the Prompts</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Step 4: Add Notes (Optional)</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Lightbulb className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Pro Tip</p>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <div className="space-y-6 mt-8">
                <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
                  <h3 className="text-xl font-semibold text-green-800 dark:text-green-200 mb-3">Great (5/5)</h3>
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-6 border border-emerald-200 dark:border-emerald-800">
                  <h3 className="text-xl font-semibold text-emerald-800 dark:text-emerald-200 mb-3">Good (4/5)</h3>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-6 border border-yellow-200 dark:border-yellow-800">
                  <h3 className="text-xl font-semibold text-yellow-800 dark:text-yellow-200 mb-3">Okay (3/5)</h3>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800">
                  <h3 className="text-xl font-semibold text-orange-800 dark:text-orange-200 mb-3">Meh (2/5)</h3>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-6 border border-red-200 dark:border-red-800">
                  <h3 className="text-xl font-semibold text-red-800 dark:text-red-200 mb-3">Rough (1/5)</h3>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 mt-8">
                <div className="flex items-start gap-3">
                  <TrendingUp className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Wellness Score</p>
        ...
        <section id="smart-prompts" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">How Prompts Adapt</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="space-y-4 mb-6">
                <div className="border-l-4 border-green-500 pl-4">
                  <p className="font-semibold text-gray-900 dark:text-white">For Great or Good moods:</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">What is making today a good day? What are you grateful for? What went well?</p>
                </div>
                <div className="border-l-4 border-yellow-500 pl-4">
                  <p className="font-semibold text-gray-900 dark:text-white">For Okay moods:</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">What is on your mind? How is your energy level? Anything notable about today?</p>
                </div>
                <div className="border-l-4 border-red-500 pl-4">
                  <p className="font-semibold text-gray-900 dark:text-white">For Meh or Rough moods:</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">What is challenging you? Would you like to talk about it? What would help right now?</p>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Why This Matters</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <MessageCircle className="w-5 h-5 text-pink-600 dark:text-pink-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-pink-900 dark:text-pink-100 mb-2">Optional Responses</p>
                    <p className="text-pink-800 dark:text-pink-200 text-sm">
        ...
        <section id="streaks" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">How Streaks Work</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Benefits of Maintaining Streaks</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Lightbulb className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Do Not Stress About Broken Streaks</p>
                    <p className="text-amber-800 dark:text-amber-200 text-sm">
        ...
        <section id="partner-mood" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What You Can See</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Why This Helps Your Relationship</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Heart className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Thoughtful, Not Intrusive</p>
                    <p className="text-purple-800 dark:text-purple-200 text-sm">
        ...
        <section id="reactions" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Available Reactions</h3>
              <div className="grid gap-4 sm:grid-cols-3 mb-6">
                <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-4 text-center">
                  <div className="text-4xl mb-2">❤️</div>
                  <p className="font-semibold text-pink-900 dark:text-pink-100">Heart</p>
                  <p className="text-sm text-pink-700 dark:text-pink-300">Send love and appreciation</p>
                </div>
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 text-center">
                  <div className="text-4xl mb-2">🤗</div>
                  <p className="font-semibold text-purple-900 dark:text-purple-100">Hug</p>
                  <p className="text-sm text-purple-700 dark:text-purple-300">Offer comfort and support</p>
                </div>
                <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-4 text-center">
                  <div className="text-4xl mb-2">💪</div>
                  <p className="font-semibold text-indigo-900 dark:text-indigo-100">Strength</p>
                  <p className="text-sm text-indigo-700 dark:text-indigo-300">Show encouragement</p>
                </div>
              </div>

              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">When to Send Reactions</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <MessageCircle className="w-5 h-5 text-green-600 dark:text-green-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-green-900 dark:text-green-100 mb-2">Low Effort, High Impact</p>
        ...
        <section id="notifications" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Notification Types</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Customizing Notifications</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Thoughtful Timing</p>
        ...
        <section id="privacy" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What Your Partner Can See</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What Stays Private</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Who Else Can See Your Data?</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-gray-100 dark:bg-gray-700 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <MessageCircle className="w-5 h-5 text-gray-600 dark:text-gray-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Your Data, Your Control</p>
        ...
        <section id="calendar-view" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Reading the Calendar</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Navigation</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Spotting Patterns</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Tip: Month-at-a-Glance</p>
                    <p className="text-blue-800 dark:text-blue-200 text-sm">
        ...
        <section id="list-view" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What List View Shows</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">When to Use List View</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Clock className="w-5 h-5 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-indigo-900 dark:text-indigo-100 mb-2">Scroll Through Time</p>
        ...
        <section id="history" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Accessing History</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What to Look For</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-green-900 dark:text-green-100 mb-2">Celebrate Progress</p>
                    <p className="text-green-800 dark:text-green-200 text-sm">
        ...
        <section id="editing" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What You Can Edit</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Editing Limitations</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">How to Edit</h3>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Lightbulb className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">End-of-Day Updates</p>
                    <p className="text-amber-800 dark:text-amber-200 text-sm">
        ...
        <section id="weekly-insights" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What the Dashboard Shows</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Understanding AI Insights</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-indigo-900 dark:text-indigo-100 mb-2">AI Improves Over Time</p>
                    <p className="text-indigo-800 dark:text-indigo-200 text-sm">
        ...
        <section id="distribution" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Reading the Chart</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What Distribution Tells You</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <TrendingUp className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Track Shifts Over Time</p>
                    <p className="text-purple-800 dark:text-purple-200 text-sm">
        ...
        <section id="patterns" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Types of Patterns Detected</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Example Insights</h3>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-green-900 dark:text-green-100 mb-2">Actionable Insights</p>
                    <p className="text-green-800 dark:text-green-200 text-sm">
        ...
        <section id="confidence" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What Confidence Means</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Factors Affecting Confidence</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Sparkles className="w-5 h-5 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-indigo-900 dark:text-indigo-100 mb-2">Building Confidence</p>
                    <p className="text-indigo-800 dark:text-indigo-200 text-sm">
        ...
        <section id="wellness-score" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">How It Is Calculated</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Interpreting Your Score</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <TrendingUp className="w-5 h-5 text-pink-600 dark:text-pink-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-pink-900 dark:text-pink-100 mb-2">Track Trends, Not Single Points</p>
                    <p className="text-pink-800 dark:text-pink-200 text-sm">
        ...
        <section id="daily-habit" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Choose Your Time</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Habit Stacking</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Use Reminders</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Lightbulb className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Start Small</p>
                    <p className="text-amber-800 dark:text-amber-200 text-sm">
        ...
        <section id="honesty" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Why Honesty Matters</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Common Temptations to Avoid</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Heart className="w-5 h-5 text-pink-600 dark:text-pink-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-pink-900 dark:text-pink-100 mb-2">Vulnerability Is Strength</p>
                    <p className="text-pink-800 dark:text-pink-200 text-sm">
        ...
        <section id="context" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What to Include</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Example Notes</h3>
              <div className="space-y-3 mb-6">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Lightbulb className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Future You Will Thank You</p>
                    <p className="text-amber-800 dark:text-amber-200 text-sm">
        ...
        <section id="support" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Checking Their Mood</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Responding Appropriately</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What NOT to Do</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Heart className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Simple Acknowledgment Goes Far</p>
                    <p className="text-purple-800 dark:text-purple-200 text-sm">
        ...
        <section id="weekly-review" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Weekly Review Ritual</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Questions to Ask Yourself</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-green-900 dark:text-green-100 mb-2">Make It a Couple Activity</p>
                    <p className="text-green-800 dark:text-green-200 text-sm">
        ...
        <section id="missed-days" className="mt-8 scroll-mt-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What Happens When You Miss</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">What You Cannot Do</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">The Healthy Mindset</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 mt-6">
                <div className="flex items-start gap-3">
                  <Heart className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Self-Compassion First</p>
                    <p className="text-amber-800 dark:text-amber-200 text-sm">
