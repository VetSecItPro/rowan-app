        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700/20 rounded-2xl p-6">
              ...
              <div className="bg-orange-900/20 border border-orange-800 rounded-xl p-4 mb-4">
            ...
            <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700/20 rounded-2xl p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-semibold text-white mb-1">Marketing Communications</h2>
                  <p className="text-sm text-gray-400">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-gray-900/50 rounded-xl">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">Receive product updates and offers via email</p>
                  </div>
                  <Toggle
                    id="marketing-emails"
            ...
            <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700/20 rounded-2xl p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-semibold text-white mb-1">Data Sharing</h2>
                  <p className="text-sm text-gray-400">
            ...
            {agreements.length > 0 && (
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700/20 rounded-2xl p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-xl font-semibold text-white mb-1">Data Processing Agreements</h2>
                    <p className="text-sm text-gray-400">
