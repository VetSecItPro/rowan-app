        ...
        <div className="max-w-5xl mx-auto p-4 sm:p-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">Support & Help</h1>
                <p className="text-gray-600 dark:text-gray-400 mt-1">Get help and connect with us</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Link
              ...
              className="group p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border-2 border-gray-200/50 dark:border-gray-700/50 hover:border-purple-500 hover:shadow-purple-500/50 rounded-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-200"
            >
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 rounded-xl hover:shadow-lg transition-shadow"
              >
                <Bug className="w-8 h-8 text-red-500 mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Report a Bug</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          {/* FAQ Section */}
          <div className="p-6 bg-purple-50/60 dark:bg-purple-900/40 backdrop-blur-md border border-purple-200/50 dark:border-purple-800/50 rounded-xl">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Frequently Asked Questions</h3>
            <div className="space-y-4">
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white mb-1">How do I invite my partner?</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Go to Settings → Space Settings and use the invite feature to send an invitation email.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white mb-1">Can I use Rowan offline?</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
