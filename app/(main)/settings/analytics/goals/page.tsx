    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          {/* Time Range Toggle */}
          <div className="inline-flex items-center bg-indigo-900/20 rounded-lg p-1 border border-indigo-800">
            {[
              ...
              <div className="bg-gradient-to-r from-indigo-900/20 to-purple-900/20 border border-indigo-800 rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-indigo-300">Current Streak</p>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-green-300">Avg Days to Complete</p>
                  </div>
                  <div className="text-center">
