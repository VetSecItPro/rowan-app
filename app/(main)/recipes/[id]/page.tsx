        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={deleting}
              className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 rounded-lg transition-colors flex items-center gap-2 border border-red-400/30 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {deleting ? (
                <>
