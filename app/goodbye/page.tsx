        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8 text-center">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl p-6 mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-blue-900 dark:text-blue-100">30-Day Grace Period</h2>
            </div>
          ...
          <div className="text-left space-y-4 mb-8">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 text-center">What happens next:</h3>
            ...
            <div className="grid gap-3">
              <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">You'll receive reminder emails before permanent deletion.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">5-Day Warning</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">You'll get a final warning 5 days before permanent deletion.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">After 30 days, all your data will be permanently removed.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-lg font-semibold text-gray-900 dark:text-white">Thank You</span>
            </div>
