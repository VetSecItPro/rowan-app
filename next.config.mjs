...
const nextConfig = {
  ...
  experimental: {
    ...
    optimizePackageImports: [
      'lucide-react', 'framer-motion', 'date-fns', '@supabase/supabase-js', 'sonner',
      'recharts', '@dnd-kit/core', '@dnd-kit/sortable', '@radix-ui/react-avatar',
      '@radix-ui/react-progress', '@radix-ui/react-scroll-area', 'zod',
    ],
