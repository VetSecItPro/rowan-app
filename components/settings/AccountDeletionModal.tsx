      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl border border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-start gap-3 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
            ...
            <div>
              <h3 className="font-medium text-red-800 dark:text-red-200 mb-1">Permanent Account Deletion</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">What happens when you delete your account:</h3>

            <div className="grid gap-3">
              <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <Calendar className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">30-Day Grace Period</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Your account will be marked for deletion but you can cancel anytime within 30 days.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">Data Removal</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">All your personal data (expenses, tasks, messages, etc.) will be permanently deleted.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">Data Export Recommended</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Download a copy of your data before deletion (GDPR compliance).</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <h4 className="font-medium text-gray-900 dark:text-white">Export Your Data (Recommended)</h4>
              {hasExported && (
