...
export function TwoFactorAuth({ onStatusChange }: TwoFactorAuthProps) {
  ...
  if (isLoading) {
    return (
      <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg sm:rounded-xl p-4 sm:p-6 animate-pulse">
    ...
    <>
      ...
      {showSetupModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {qrCode ? (
                  <div className="bg-white p-4 rounded-xl border border-gray-200 dark:border-gray-700 text-center">
                    <img
                      src={qrCode}
                      alt="2FA QR Code"
                      loading="eager"
                ...
                {secret && (
                  <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                    ...
                    <code className="text-xs font-mono bg-white dark:bg-gray-800 px-2 py-1 rounded border break-all">
                      {secret}
                    </code>
                  </div>
                )}
