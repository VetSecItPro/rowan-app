      ...
      {duplicates.map((group, index) => {
        ...
        return (
          <div
            ...
            className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-500 dark:border-amber-600 rounded-lg p-4"
          >
            {/* Header */}
            <div className="flex items-start gap-3 mb-3">
              ...
              {onDismiss && (
                <button
                  ...
                  className="flex-shrink-0 p-1 rounded-lg text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-900/40 transition-colors"
                  aria-label="Dismiss"
                >
                  <X className="w-4 h-4" />
                </button>
            ...
            <div className="bg-amber-100 dark:bg-amber-900/30 rounded-lg p-2 mb-3">
              <div className="flex items-center justify-between text-sm">
                <span className="text-amber-800 dark:text-amber-200">Similarity Score:</span>
