            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md">
              ...
              <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <button
                  ...
                  className="btn-touch px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 active:scale-95 hover:shadow-lg"
                >
                  {isExporting ? (
                    <>
