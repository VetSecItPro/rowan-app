        ...
        <div ref={portalRef}>
          ...
          <div
            className={`shadow-2xl z-[9999] flex flex-col animate-in ${
              isDesktop
                ? 'bg-gray-900 w-80 max-h-[calc(100vh-5rem)] rounded-xl border border-gray-700 slide-in-from-top-2 fade-in duration-200'
                : 'fixed top-4 right-4 w-52 bg-gray-900/70 backdrop-blur-2xl rounded-2xl border border-white/10 shadow-xl slide-in-from-top-2 fade-in duration-200'
            }`}
            style={menuStyle}
          >
            {/* Mobile Header - Compact */}
            <div className="flex-shrink-0 flex items-center justify-between px-3 py-2.5 border-b border-gray-700/30 sm:hidden">
                ...
                {NAVIGATION_ITEMS.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg hover:bg-white/10 transition-colors active:scale-[0.98]"
                    >
