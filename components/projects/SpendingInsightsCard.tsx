              ...
              return (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="relative h-8 bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden">
                      <div
                      ...
                      {heightPercentage <= 20 && trend.total_spent > 0 && (
                        <span className="absolute right-2 top-1/2 -translate-y-1/2 text-xs font-semibold text-gray-600 dark:text-gray-400">
                          ${trend.total_spent.toLocaleString()}
                        </span>
                      )}
                    </div>
                  </div>
                  <div className="w-20 text-xs text-gray-500 dark:text-gray-500 text-right">
            ...
            <div className="space-y-2">
              {budget_variances.slice(0, 5).map((variance, index) => (
                ...
                >
                  ...
                  <div className="mt-2 relative h-1.5 bg-white dark:bg-gray-800 rounded-full overflow-hidden">
                    <div
