    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8">
          ...
          <div className="w-96 h-6 bg-gray-100 dark:bg-gray-800 rounded animate-pulse"></div>
        </div>
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="w-12 h-6 bg-gray-100 dark:bg-gray-700 rounded animate-pulse"></div>
              </div>
              <div className="w-20 h-8 bg-gray-300 dark:bg-gray-600 rounded animate-pulse mb-2"></div>
              <div className="w-32 h-4 bg-gray-100 dark:bg-gray-700 rounded animate-pulse"></div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-3">
                  {[1, 2, 3].map((j) => (
                    <div key={j} className="flex items-center gap-3">
                      ...
                      <div className="flex-1 h-4 bg-gray-100 dark:bg-gray-700 rounded animate-pulse"></div>
                      <div className="w-16 h-4 bg-gray-100 dark:bg-gray-700 rounded animate-pulse"></div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <div className="w-24 h-6 bg-gray-200 dark:bg-gray-600 rounded animate-pulse mb-4"></div>
                <div className="space-y-2">
                  {[1, 2, 3].map((j) => (
                    <div key={j} className="h-4 bg-gray-100 dark:bg-gray-700 rounded animate-pulse"></div>
                  ))}
                </div>
              </div>
            ))}
