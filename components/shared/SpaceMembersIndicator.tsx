        ...
        return (
          ...
          >
            ...
            <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 hidden group-hover:block z-50">
              <div className="bg-gray-800 text-gray-100 text-xs rounded-lg px-3 py-1.5 whitespace-nowrap shadow-lg">
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-b-4 border-transparent border-b-gray-800"></div>
                {member.users.name}
                {isCurrentUser && ' (You)'}
              </div>
            </div>
