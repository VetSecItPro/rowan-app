            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-20 px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    />
              ...
              <div>
                ...
                <input
                  ...
                  className="px-4 py-3 border border-gray-600 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-lg"
                />
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        settings.enable_reminders ? 'bg-indigo-600' : 'bg-gray-700'
                      }`}
                    >
                      <span
                  ...
                  {settings.enable_reminders && (
                    <div className="relative z-50">
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 relative z-50"
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        settings.auto_schedule ? 'bg-indigo-600' : 'bg-gray-700'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="bg-indigo-900/20 border border-indigo-700 rounded-lg p-4">
                <h4 className="font-medium text-indigo-100 mb-2">Preview</h4>
