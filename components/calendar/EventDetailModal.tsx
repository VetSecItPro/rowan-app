...
import { Calendar, Clock, MapPin, MessageCircle, Paperclip, Edit, Trash2, CheckCircle, AlertCircle, PlayCircle } from 'lucide-react';
    ...
    >
      <div className="space-y-4">
        {/* Category & Status Row */}
          ...
          {/* Tab Navigation */}
          <div className="bg-gray-800/50 -mx-4 sm:-mx-6 px-4 sm:px-6 py-2 flex gap-2 mt-4">
            <button
          ...
          {/* Tab Content */}
          <div className="-mx-4 sm:-mx-6 px-4 sm:px-6 py-4 min-h-[200px] max-h-[300px] overflow-y-auto bg-gray-900">
            {activeTab === 'comments' ? (
