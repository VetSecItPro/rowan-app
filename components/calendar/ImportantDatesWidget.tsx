      ...
      <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-50 to-white p-4 dark:border-gray-800 dark:from-gray-900 dark:to-gray-800">
        <div className="flex items-center justify-between">
          ...
          {onAddDate && (
            <button
              onClick={onAddDate}
              className="flex items-center gap-1.5 rounded-lg bg-pink-100 px-3 py-1.5 text-xs font-medium text-pink-700 transition-colors hover:bg-pink-200 dark:bg-pink-900/30 dark:text-pink-400 dark:hover:bg-pink-900/50"
            >
      ...
      {showHeader && (
        <div className="mb-3 flex items-center justify-between">
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            ...
            <h3 className="text-sm font-semibold">Important Dates</h3>
            <span className="rounded-full bg-pink-100 px-1.5 py-0.5 text-xs font-medium text-pink-700 dark:bg-pink-900/30 dark:text-pink-400">
              {dates.length}
            </span>
          </div>
          {onAddDate && (
            <div className="relative group">
              <button
                onClick={onAddDate}
                className="flex items-center gap-1 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-gray-100 hover:text-pink-600 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-pink-400"
              >
