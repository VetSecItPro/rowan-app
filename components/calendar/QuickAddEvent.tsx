...
Best,
Sarah"
                className="w-full px-4 py-4 bg-gray-50 dark:bg-gray-900 border-2 border-purple-200 dark:border-purple-700 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 dark:text-white text-sm placeholder:text-gray-400 min-h-[200px] resize-y"
              />
              {isAILoading && (
                <div className="absolute bottom-4 right-4 flex items-center gap-2 text-purple-600 dark:text-purple-400">
              ...
              <div className="grid gap-2">
                ...
                {parsedPreview.attendees && parsedPreview.attendees.length > 0 && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs text-purple-700 dark:text-purple-300 font-medium">Attendees</div>
                      <div className="text-sm text-gray-900 dark:text-white">{parsedPreview.attendees.join(', ')}</div>
                    </div>
                  </div>
                )}
                ...
                {parsedPreview.description && (
                  <div className="mt-2 pt-2 border-t border-purple-200 dark:border-purple-700">
                    <div className="text-xs text-purple-700 dark:text-purple-300 font-medium mb-1">Notes</div>
