    ...
    return (
      <div className={`bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 ${className}`}>
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-400">Loading balance...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="p-6 space-y-6">
        ...
        {isBalanced ? (
          ...
          <div className="space-y-4">
            {/* Net Balance Display */}
            <div className="text-center p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              ...
              {balances.map((balance) => (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 dark:text-gray-400">Owed to them:</span>
                      <span className="font-medium text-gray-900 dark:text-white">
                    ...
                    <div className="flex items-center justify-between text-sm pt-2 border-t border-gray-200 dark:border-gray-600">
                      <span className="font-medium text-gray-700 dark:text-gray-300">Net balance:</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">Split Expenses</p>
          </div>
          <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
              ${stats.totalSplit.toFixed(0)}
            </p>
            <p className="text-xs text-gray-600 dark:text-gray-400">Total Split</p>
          </div>
          <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <p className="text-2xl font-bold text-red-600 dark:text-red-400">
              {stats.unsettledCount}
            </p>
            <p className="text-xs text-gray-600 dark:text-gray-400">Unsettled</p>
          </div>
          <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <p className="text-2xl font-bold text-red-600 dark:text-red-400">
