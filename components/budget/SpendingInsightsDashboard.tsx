          ...
          {patterns.map((pattern) => (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-semibold text-gray-900 dark:text-white">{pattern.category}</h4>
              ...
              <div className="grid grid-cols-4 gap-3 text-sm">
                ...
                <div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Predictability</p>
                  <p className="font-semibold text-gray-900 dark:text-white">
                    {pattern.predictability.toFixed(0)}%
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Seasonality</p>
                  <span
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {forecast.slice(0, 6).map((pred) => (
            <div
              key={pred.category}
              className="p-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700"
            >
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{anomaly.message}</p>
