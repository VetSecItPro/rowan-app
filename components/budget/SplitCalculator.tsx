            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border-2 border-blue-200 dark:border-blue-800">
              ...
              {splitType === 'fixed' ? (
                <input
                  ...
                  className="w-full text-2xl font-bold text-blue-600 dark:text-blue-400 bg-transparent border-none outline-none"
                />
              ) : (
              ...
              {splitType === 'percentage' ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 text-xl font-bold text-blue-600 dark:text-blue-400 bg-transparent border-none outline-none"
                  />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border-2 border-purple-200 dark:border-purple-800">
              ...
              {splitType === 'fixed' ? (
                <input
                  ...
                  className="w-full text-2xl font-bold text-purple-600 dark:text-purple-400 bg-transparent border-none outline-none"
                />
              ) : (
              ...
              {splitType === 'percentage' ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 text-xl font-bold text-purple-600 dark:text-purple-400 bg-transparent border-none outline-none"
                  />
