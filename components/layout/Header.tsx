...
export function Header({ onBetaClick, onLaunchClick, isPublicFeaturePage }: HeaderProps = {}) {
              ...
              {user ? (
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="hidden sm:block px-3 sm:px-4 py-1.5 sm:py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-[10px] sm:text-xs font-bold rounded-full transition-all shadow-sm active:scale-95 whitespace-nowrap"
                  >
                    Get Notified
                  </button>
                </div>
