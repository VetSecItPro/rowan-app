      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-[calc(72px+env(safe-area-inset-bottom))] md:bottom-0 z-50 w-full sm:w-[520px] flex flex-col bg-gray-900 border-l border-gray-700/50 shadow-2xl"
          >
            {panelContent}
          </motion.div>
        </>
