                    ...
                    <div className="absolute bottom-full mb-2 left-0 w-56 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-20">
                      ...
                      <div className="p-2">
                        ...
                        <button
                          ...
                          className="w-full text-left px-3 py-2 text-sm text-orange-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
                        >
                          <AlertCircle className="w-3 h-3 inline mr-2" />
                          High
                        </button>
                        <button
                          ...
                          className="w-full text-left px-3 py-2 text-sm text-yellow-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
                        >
                          <AlertCircle className="w-3 h-3 inline mr-2" />
                          Medium
                        </button>
                        <button
                          ...
                          className="w-full text-left px-3 py-2 text-sm text-green-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
                        >
                          <AlertCircle className="w-3 h-3 inline mr-2" />
                          Low
                        </button>
