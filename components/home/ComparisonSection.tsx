    ...
    return (
        <section className="relative py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                {/* Mobile scroll hint */}
                <div className="md:hidden flex items-center justify-center gap-2 mb-3 text-xs text-gray-400">
                    ...
                    <table className="w-full text-sm min-w-[640px]">
                        <thead>
                            <tr className="border-b border-gray-700">
                                <th className="text-left py-4 px-4 font-display font-semibold text-white">Feature</th>
                                <th className="text-center py-4 px-3 font-medium text-gray-400">Task Apps</th>
                                <th className="text-center py-4 px-3 font-medium text-gray-400">Calendars</th>
                                <th className="text-center py-4 px-3 font-medium text-gray-400">List Apps</th>
                                <th className="text-center py-4 px-3 font-medium text-gray-400">Meal Apps</th>
                                <th className="text-center py-4 px-3 font-medium text-gray-400">Budget Apps</th>
                                <th className="text-center py-4 px-3 font-display font-bold bg-gradient-to-r from-blue-600 from-blue-400 to-cyan-400 bg-clip-text text-transparent">Rowan</th>
                            </tr>
                        </thead>
                            ...
                            {[
                                ...
                                <tr key={row.feature} className="hover:bg-gray-800/30 transition-colors">
                                    ...
                                    {row.cols.map((val, colIdx) => (
                                        <td key={colIdx} className={`text-center py-3 px-3 ${colIdx === 5 ? 'bg-blue-900/10' : ''}`}>
                                            {val === true ? (
                                                ...
                                                <span className="text-gray-500 text-xs">Some</span>
                                            ) : val === 'rare' ? (
                                                <span className="text-gray-500 text-xs">Rare</span>
                                            ) : (
                ...
                <motion.p
                    ...
                    className="text-center mt-8 text-gray-400 font-serif italic"
                >
