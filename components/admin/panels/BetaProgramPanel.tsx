  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-sm text-gray-400">Loading beta program...</span>
      </div>
    );
  }
    ...
    <div className="flex-1 flex flex-col space-y-4 min-h-0">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 text-sm bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white"
        />
      </div>
      ...
      <div className="border border-gray-700 rounded-lg overflow-hidden flex-1 flex flex-col min-h-0">
        <div className="bg-gray-800 px-4 py-2 border-b border-gray-700 flex-shrink-0">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-gray-400 uppercase">Beta Users</span>
          ...
          {filteredUsers.length > 0 ? (
            <div className="divide-y divide-gray-700">
              {filteredUsers.slice(0, 10).map((user) => (
                <div key={user.id} className="px-4 py-3 flex items-center justify-between hover:bg-gray-800/50">
