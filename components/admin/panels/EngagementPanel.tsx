  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-sm text-gray-600 dark:text-gray-400">Loading session data...</span>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{trafficMetrics.uniqueSessions}</p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Pages per Session</span>
          </div>
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{trafficMetrics.avgPagesPerSession}</p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Avg. Session Duration</span>
          </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4 text-purple-500" />
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Activity by Hour (UTC)</h3>
          </div>
          <button
            onClick={() => refetch()}
        ...
        {hourlyActivity.length > 0 ? (
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">No hourly data available</p>
        )}
      </div>

      {/* Session Insights */}
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">Session Insights</h3>

        <div className="space-y-4">
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <h4 className="text-sm font-medium text-blue-700 dark:text-blue-300">Session Duration Tracking</h4>
          ...
          <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
            <h4 className="text-sm font-medium text-purple-700 dark:text-purple-300">Bounce Rate</h4>
          ...
          <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
            <h4 className="text-sm font-medium text-green-700 dark:text-green-300">Return Visitors</h4>
