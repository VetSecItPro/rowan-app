...
export function DeleteMessageModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] sm:flex sm:items-center sm:justify-center sm:p-4">
      ...
      {/* Modal */}
      <div className="absolute top-14 left-0 right-0 bottom-0 sm:relative sm:inset-auto sm:top-auto bg-gray-900 sm:rounded-2xl shadow-2xl sm:max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col">
        {/* Header */}
        <div className="flex-shrink-0 flex items-center justify-between px-5 py-3 sm:py-4 border-b border-gray-700">
          ...
          <button
            onClick={onClose}
            disabled={isDeleting}
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-800 transition-colors disabled:opacity-50"
          >
        ...
        {/* Footer */}
        <div className="flex gap-3 px-5 py-4 border-t border-gray-700 bg-gray-800/50">
          <button
            onClick={onClose}
            disabled={isDeleting}
            className="flex-1 px-4 py-2.5 rounded-xl font-medium text-gray-300 bg-gray-800 border border-gray-600 hover:bg-gray-700 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
